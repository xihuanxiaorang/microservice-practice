...
VALUES ('client', '', '{noop}123456', 'all', 'authorization_code,password,client_credentials,implicit,refresh_token',
        'https://www.baidu.com', NULL, 3600, 259200, NULL, 'true');
